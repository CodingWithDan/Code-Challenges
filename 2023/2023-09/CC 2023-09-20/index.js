//================================================================================================
//CW: Coding Meetup #7 - Higher-Order Functions Series - Find the most senior developer
//================================================================================================
...
function findSenior(list) {
    let oldest = list.sort((a, b) =>  b.age - a.age)
    let arr = [oldest[0]]
    
    for (let i = 1; i < oldest.length; i++){
      if(oldest[0].age === oldest[i].age){
        arr.push(oldest[i])
      }
    } 
    return arr
  ...
  function findSenior(list) {
    ...
    return oldest.filter(x => oldest[0].age === x.age)
