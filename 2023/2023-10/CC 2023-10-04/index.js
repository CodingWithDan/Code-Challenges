...
//===================================================================================
//CW: Coding Meetup #16 - Higher-Order Functions Series - Ask for missing details
//===================================================================================
...
function askForMissingDetails(list) {
    ...
    const developersWithMissingDetails = [];
  
    for (const developer of list) {
      for (const key in developer) {
        if (developer[key] === null) {
          developer.question = `Hi, could you please provide your ${key}.`;
          developersWithMissingDetails.push(developer);
          break; // Stop checking other properties for this developer
        }
      }
    }
  ...
  function askForMissingDetails(list) {
    return list.filter(x => {
      for(const key in x){
        if(x[key] === null){
          return x['question'] = `Hi, could you please provide your ${key}.`
        }
      }
    })
  }